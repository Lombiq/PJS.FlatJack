...
namespace PJS.FlatJack {
    public class ResourceManifest : IResourceManifestProvider {
        public void BuildManifests(ResourceManifestBuilder builder) {
            ...
            manifest.DefineScript("ValidationEngine-en").SetUrl("jquery.validationEngine-en.js").SetVersion("2.6.2").SetDependencies("jQuery");
            manifest.DefineScript("ValidationEngine").SetUrl("jquery.validationEngine.js").SetVersion("2.6.2").SetDependencies("ValidationEngine-en");
            ...
            manifest.DefineStyle("ValidationEngine").SetUrl("validationEngine.jquery.css");
